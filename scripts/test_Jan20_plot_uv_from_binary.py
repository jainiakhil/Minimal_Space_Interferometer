...
#plt.legend()
plt.grid(True)
plt.savefig('C:\Users\User\Desktop\Thesis Part 1\Tests\EPS Plots from Binary\[%s] u-v Plot with Hermitian for 2 weeks for source at %0.0f hr and %0.0f deg beam angle 120 deg.eps' % (sst, nsrahr, nsdecdeg), format = 'eps')
