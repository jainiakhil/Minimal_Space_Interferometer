...
sourcename = "[13-03-2020 00;07;53] Source Info for 2 weeks for source at 0 hr 00 deg beam angle 120 deg.npy"
arrayname = "[13-03-2020 00;07;53] u-v Array for 2 weeks for source at 0 hr 00 deg beam angle 120 deg.npy"
...
gridfig1 = plt.savefig('C:\Users\User\Desktop\Thesis Part 1\Tests\EPS Plots from Binary\[%s] Coverage due to Sat 1 and Sat 2 - Uniformly Weighted for 2 weeks for source at %0.0f h and %0.0f deg beam angle 120 deg.eps' % (sst, nsrahr, nsdecdeg), format = 'eps', bbox_inches = 'tight')
...
gridfig2 = plt.savefig('C:\Users\User\Desktop\Thesis Part 1\Tests\EPS Plots from Binary\[%s] Coverage due to Sat 2 and Sat 3 - Uniformly Weighted for 2 weeks for source at %0.0f h and %0.0f deg beam angle 120 deg.eps' % (sst, nsrahr, nsdecdeg), format = 'eps', bbox_inches = 'tight')
...
gridfig3 = plt.savefig('C:\Users\User\Desktop\Thesis Part 1\Tests\EPS Plots from Binary\[%s] Coverage due to Sat 3 and Sat 1 - Uniformly Weighted for 2 weeks for source at %0.0f h and %0.0f deg beam angle 120 deg.eps' % (sst, nsrahr, nsdecdeg), format = 'eps', bbox_inches = 'tight')
...
gridfig4 = plt.savefig('C:\Users\User\Desktop\Thesis Part 1\Tests\EPS Plots from Binary\[%s] Coverage Total - Uniformly Weighted for 2 weeks for source at %0.0f h and %0.0f deg beam angle 120 deg.eps' % (sst, nsrahr, nsdecdeg), format = 'eps', bbox_inches = 'tight')
...
fftimg = plt.savefig('C:\Users\User\Desktop\Thesis Part 1\Tests\EPS Plots from Binary\[%s] Dirty Beam - Uniformly Weighted for 2 weeks for source at %0.0f h and %0.0f deg beam angle 120 deg.eps' % (sst, nsrahr, nsdecdeg), format = 'eps', bbox_inches = 'tight')
